...
OpenSyria Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring OpenSyria Core

**When configuring OpenSyria Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring OpenSyria Core:
...
variables will be set when generating the OpenSyria Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
