...
"""
Test starting opensyriad with -bind and/or -bind=...=onion, confirm that
...
class BindExtraTest(OpenSyriaTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that opensyriad has bound on "::1" (for RPC) and "::" (for P2P).
