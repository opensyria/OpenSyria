...
def cltv_invalidate(tx, failure_reason):
    ...
    scheme = [
        ...
        [[CScriptNum(20000), OP_CHECKLOCKTIMEVERIFY, OP_DROP],  0,          TIME_GENESIS_BLOCK],
        [[CScriptNum(20000), OP_CHECKLOCKTIMEVERIFY, OP_DROP],  0,          50],
...
class BIP65Test(OpenSyriaTestFramework):
