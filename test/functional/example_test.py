...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the OpenSyriaTestFramework
    pass


class ExampleTest(OpenSyriaTestFramework):
    # Each functional test is a subclass of the OpenSyriaTestFramework class.
    ...
    def custom_method(self):
        ...
        OpenSyriaTestFramework class so other tests can use it."""
