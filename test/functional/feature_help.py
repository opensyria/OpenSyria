#!/usr/bin/env python3
# Copyright (c) 2018-2021 The OpenSyria Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting opensyria with -h works as expected."""

from test_framework.test_framework import OpenSyriaTestFramework
from test_framework.util import assert_equal

class HelpTest(OpenSyriaTestFramework):
    ...
    def run_test(self):
        self.log.info("Start opensyria with -h for help text")
        ...
        self.log.info("Start opensyria with -version for version information")
        ...
        self.log.info("Start opensyriad with -fakearg to make sure it does not start")
