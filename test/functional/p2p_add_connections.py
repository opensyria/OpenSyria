...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The opensyriad node closes feeler connections as soon as a version
...
class P2PAddConnections(OpenSyriaTestFramework):
    ...
    def run_test(self):
        ...
        # opensyriad behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that opensyriad sends its own version prior to processing
