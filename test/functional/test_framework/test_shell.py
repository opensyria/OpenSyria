...
class TestShell:
    """Wrapper Class for OpenSyriaTestFramework.

    The TestShell class extends the OpenSyriaTestFramework
    ...
    class __TestShell(OpenSyriaTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by OpenSyriaTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # OpenSyriaTestFramework instances are supposed to be constructed with the path
