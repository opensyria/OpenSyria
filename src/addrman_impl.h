...
#ifndef OPENSYRIA_ADDRMAN_IMPL_H
#define OPENSYRIA_ADDRMAN_IMPL_H
 ...
 * see https://opensyria.org/en/2024/07/31/disclose-addrman-int-overflow/
 */
...
#endif // OPENSYRIA_ADDRMAN_IMPL_H
