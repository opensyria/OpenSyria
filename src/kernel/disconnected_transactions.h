...
#ifndef OPENSYRIA_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define OPENSYRIA_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // OPENSYRIA_KERNEL_DISCONNECTED_TRANSACTIONS_H
