...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As OpenSyria relies on 80 byte header hashes, we want to have an example for that.",
               "9e8e45a12a95460afd97398619292cfd902c2eeb83053e5ae0ecbba56c52fd45");
