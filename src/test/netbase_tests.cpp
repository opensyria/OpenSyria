...
{
    BOOST_CHECK(TestSplitHost("www.opensyria.org", "www.opensyria.org", 0));
    BOOST_CHECK(TestSplitHost("[www.opensyria.org]", "www.opensyria.org", 0));
    BOOST_CHECK(TestSplitHost("www.opensyria.org:80", "www.opensyria.org", 80));
    BOOST_CHECK(TestSplitHost("[www.opensyria.org]:80", "www.opensyria.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.opensyria.org:65536", "www.opensyria.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.opensyria.org:0", "www.opensyria.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.opensyria.org:", "www.opensyria.org:", 0, false));
}
