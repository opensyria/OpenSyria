...
#ifndef OPENSYRIA_IPC_CAPNP_COMMON_TYPES_H
#define OPENSYRIA_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between opensyria processes.
...
//! Functions to serialize / deserialize common opensyria types.
namespace mp {
...
#endif // OPENSYRIA_IPC_CAPNP_COMMON_TYPES_H
