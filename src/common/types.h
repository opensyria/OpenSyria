...
//! that can be used internally by functions in the libopensyria_common library,
...
#ifndef OPENSYRIA_COMMON_TYPES_H
#define OPENSYRIA_COMMON_TYPES_H
...
#endif // OPENSYRIA_COMMON_TYPES_H
