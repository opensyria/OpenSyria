...
#ifndef OPENSYRIA_TXREQUEST_H
#define OPENSYRIA_TXREQUEST_H
 ...
 *   specific transaction. See https://opensyria.org/en/2024/07/03/disclose_already_asked_for.
 */
