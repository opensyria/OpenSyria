...
{
    // Test regression https://github.com/OpenSyria/OpenSyria/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/opensyria-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/opensyria-core/gui/pull/568.
    // With fListen=false in ~/.config/OpenSyria/OpenSyria-Qt.conf and all else left as default,
    // opensyria-qt should set both -listen and -listenonion to false and start successfully.
