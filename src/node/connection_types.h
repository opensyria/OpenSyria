...
#ifndef OPENSYRIA_NODE_CONNECTION_TYPES_H
#define OPENSYRIA_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/opensyria-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on OpenSyria’s Peer-to-Peer Network")
...
#endif // OPENSYRIA_NODE_CONNECTION_TYPES_H
