// Copyright (c) 2012-present The OpenSyria Core developers & OpenSyria developers
 ...
 * for both opensyriad and opensyria-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("OpenSyria");


#include <opensyria-build-info.h>
// The <opensyria-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure OpenSyria Core copyright is not removed by accident
    if (copyright_devs.find("OpenSyria Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The OpenSyria Core developers & OpenSyria developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/OpenSyria/OpenSyria>";
