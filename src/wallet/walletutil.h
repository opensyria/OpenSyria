...
#ifndef OPENSYRIA_WALLET_WALLETUTIL_H
#define OPENSYRIA_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! opensyria from opening the wallet, thinking it was newly created, and
...
#endif // OPENSYRIA_WALLET_WALLETUTIL_H
