...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{
        "getnewaddress",
        "Returns a new OpenSyria address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new opensyria address"
                },
                RPCExamples{
...
RPCHelpMan getrawchangeaddress()
{
    return RPCHelpMan{
        "getrawchangeaddress",
        "Returns a new OpenSyria address, for receiving change.\n"
...
RPCHelpMan setlabel()
{
    return RPCHelpMan{
        ...
        "Sets the label associated with the given address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The opensyria address to be associated with a label."},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid OpenSyria address");
    }
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The opensyria address"},
...
RPCHelpMan getaddressinfo()
{
    return RPCHelpMan{
        ...
        "Return information about the given opensyria address.\n"
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The opensyria address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The opensyria address validated."},
...
RPCHelpMan walletdisplayaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "opensyria address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
