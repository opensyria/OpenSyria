...
#ifndef OPENSYRIA_INTERFACES_NODE_H
#define OPENSYRIA_INTERFACES_NODE_H
...
public:
    ...
    //! Return setting value from <datadir>/settings.json or opensyria.conf.
...
#endif // OPENSYRIA_INTERFACES_NODE_H
