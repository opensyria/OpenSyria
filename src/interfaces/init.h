...
#ifndef OPENSYRIA_INTERFACES_INIT_H
#define OPENSYRIA_INTERFACES_INIT_H
...
//! (opensyria-gui, opensyria-node, opensyria-wallet, opensyriad, opensyria-qt) and each
...
#endif // OPENSYRIA_INTERFACES_INIT_H
