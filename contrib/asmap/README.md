...
be used in OpenSY with the `-asmap` option.
...
to binary before being used with OpenSY.
...
the `opensy-cli getnodeaddresses` command.
...
```
opensy-cli getnodeaddresses 0 > addrs.json
```
