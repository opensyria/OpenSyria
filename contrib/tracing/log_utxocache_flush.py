...
"""Example logging OpenSyria Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/opensyriad
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[opensyriad_with_usdts])
