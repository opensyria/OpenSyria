...
"""Example logging OpenSY utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/opensyd
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[opensyd_with_usdts])
