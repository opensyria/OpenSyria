...
This directory contains the files necessary to perform bootstrappable OpenSyria
Core builds.
...
To build OpenSyria Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      OpenSyria Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/opensyria-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/opensyria-core/guix.sigs).
