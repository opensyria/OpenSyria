...
This directory contains the files necessary to perform bootstrappable OpenSY
Core builds.
...
To build OpenSY reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/opensy-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/opensy-core/guix.sigs).
