...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef OPENSY_CHAINPARAMSSEEDS_H\n')
    g.write('#define OPENSY_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the opensy network\n')
    ...
    g.write('#endif // OPENSY_CHAINPARAMSSEEDS_H\n')
