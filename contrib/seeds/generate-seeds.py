...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef OPENSYRIA_CHAINPARAMSSEEDS_H\n')
    g.write('#define OPENSYRIA_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the opensyria network\n')
    ...
    g.write('#endif // OPENSYRIA_CHAINPARAMSSEEDS_H\n')
