...
Assumeutxo is a feature that allows fast bootstrapping of a validating opensyd
instance.
...
```
$ opensy-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ opensy-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
