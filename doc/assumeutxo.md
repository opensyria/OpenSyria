...
Assumeutxo is a feature that allows fast bootstrapping of a validating opensyriad
instance.
...
```
$ opensyria-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ opensyria-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
