UNIX BUILD NOTES
====================
Some notes on how to build OpenSyria Core in Unix.
...
memory available when compiling OpenSyria Core. On systems with less, gcc can be
...
To build OpenSyria Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, OpenSyria Core can
...
This example lists the steps necessary to setup and build a command line only distribution of the latest changes on Arch Linux:
    ...
    ./build/bin/opensyriad
    ./build/bin/opensyria help
