...
```sh
cmake --build build --target opensyriad opensyria-cli
cmake --build build --target opensyria-qt
cmake --build build --target bench_opensyria
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:opensyria/opensyria.git
```
...
> e.g. github.com/opensyria/opensyria.git or for the GUI github.com/opensyria-core/gui
