...
This workflow uses [Partially Signed OpenSY Transactions](https://github.com/opensy/opensy/blob/master/doc/psbt.md) (PSBTs) to transfer the transaction to and from the offline wallet for signing using the private keys.
