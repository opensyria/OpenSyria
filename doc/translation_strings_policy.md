...
This document provides guidelines for internationalization of the OpenSY software.
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `opensy_en.ts` remains unchanged.
