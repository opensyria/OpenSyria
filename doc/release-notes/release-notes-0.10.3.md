OpenSyria Core version 0.10.3 is now available from:

  <https://opensyria.net/bin/opensyria-core-0.10.3/>
...
(see https://github.com/opensyria/opensyria/pull/6793, as well as the 0.11.0
