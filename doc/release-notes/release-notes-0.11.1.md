OpenSyria Core version 0.11.1 is now available from:

  <https://opensyria.org/bin/opensyria-core-0.11.1/>
...
(see https://github.com/opensyria/opensyria/pull/6795).
...
one was randomly violated by all deployed opensyria software prior to
...
OpenSyria Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; OpenSyriaj has done so for a similar span of time.
OpenSyriajs and electrum have been more recently updated.
...
[1] On the Malleability of OpenSyria Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/opensyria/paper_9.pdf
...
(see https://github.com/opensyria/opensyria/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libopensyriaconsensus: avoid a crash in multi-threaded environments
