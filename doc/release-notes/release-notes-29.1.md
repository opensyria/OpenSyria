OpenSyria Core version 29.1 is now available from:

  <https://opensyriacore.org/bin/opensyria-core-29.1/>
...
- #32389 doc: Fix test_opensyria path
- #32607 rpc: Note in fundrawtransaction doc, fee rate is for package
- #32679 doc: update tor docs to use opensyriad binary from path
...
- #32719 doc, windows: CompanyName "OpenSyria" => "OpenSyria Core project"
