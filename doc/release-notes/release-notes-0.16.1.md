OpenSyria Core version 0.16.1 is now available from:

  <https://opensyriacore.org/bin/opensyria-core-0.16.1/>
...
- #12843 `df38b13` Test starting opensyriad with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure opensyriad processes are cleaned up when tests end (sdaftuar)
