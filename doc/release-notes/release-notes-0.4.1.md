OpenSY version 0.4.1 is now available for download at:
http://sourceforge.net/projects/opensy/files/OpenSY/opensy-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxopensy or opensyd the wallet will be rewritten, OpenSY will
...
wxOpenSY: new address visible on main window
