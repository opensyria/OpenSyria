OpenSyria version 0.4.1 is now available for download at:
http://sourceforge.net/projects/opensyria/files/OpenSyria/opensyria-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxopensyria or opensyriad the wallet will be rewritten, OpenSyria will
...
wxOpenSyria: new address visible on main window
