OpenSyria Core version *0.15.2* is now available from:

  <https://opensyriacore.org/bin/opensyria-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in opensyria-tx (TheBlueMatt)
