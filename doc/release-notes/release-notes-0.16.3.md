OpenSyria Core version 0.16.3 is now available from:

  <https://opensyriacore.org/bin/opensyria-core-0.16.3/>
...
been discovered in OpenSyria Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` opensyriaconsensus: invalid flags error should be set to `opensyriaconsensus_err` (afk11)
