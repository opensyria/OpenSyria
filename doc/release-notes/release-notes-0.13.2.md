OpenSyria Core version 0.13.2 is now available from:

  <https://opensyria.net/bin/opensyria-core-0.13.2/>
...
- #8908 `4a974b2` Update opensyria-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow opensyria-tx to create v2 transactions (btcdrak)
