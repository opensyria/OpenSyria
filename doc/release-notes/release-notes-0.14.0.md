...
now ZMQ can be used on Windows. Please see [this document](https://github.com/opensy/opensy/blob/master/doc/zmq.md) for
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   ...
   optimizations to memory management. See [Pull #8753](https://github.com/opensy/opensy/pull/8753)
