OpenSyria-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/opensyria/files/OpenSyria/opensyria-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the OpenSyria
...
New/changed settings (command-line or opensyria.conf file)
--------------------------------------------------------
